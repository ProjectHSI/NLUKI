...
$(NLUKI_HOSTROOT)/host-binutils-install.sentinel: $(NLUKI_HOSTROOT)/host-binutils-build.sentinel
	...
	mkdir -p $(NLUKI_HOST_SYSROOT_OVERLAYS)/libopcodes/usr/lib
	cd $(NLUKI_HOST_BUILDROOT)/binutils; $(MAKE) install
	cp -rfv $(NLUKI_HOST_CLASSIC_SYSROOTS)/hostsysroot/usr/lib/libopcodes-* $(NLUKI_HOST_SYSROOT_OVERLAYS)/libopcodes/lib
...
$(NLUKI_HOST_BUILDROOT)/binutils/Makefile: $(DEPENDS_ON_BINUTILS) $(NLUKI_HOSTROOT)/host-glibc-install.sentinel
	mkdir -p $(NLUKI_HOST_BUILDROOT)/binutils
	cd $(NLUKI_HOST_BUILDROOT)/binutils; \
	$(NLUKI_DESTROY_BAD_ENV_VARS); $(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_PATH,hostsysroot); $(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_CPATH,hostsysroot); $(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_LIBRARY_PATH,hostsysroot); \
	$(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_PATH,fp); $(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_CPATH,fp); $(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_LIBRARY_PATH,fp); \
...
# Configure GLibC
$(NLUKI_HOST_BUILDROOT)/glibc/Makefile: $(NLUKI_HOSTROOT)/host-fp-gcc-install.sentinel \
										$(NLUKI_HOSTROOT)/host-firstpass-binutils-install.sentinel \
										$(NLUKI_HOST_BUILDROOT)/glibc/configparams
	mkdir -p $(NLUKI_HOST_BUILDROOT)/glibc
	cd $(NLUKI_HOST_BUILDROOT)/glibc; \
	$(NLUKI_DESTROY_BAD_ENV_VARS); \
	$(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_PATH,hostsysroot); $(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_CPATH,hostsysroot); $(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_LIBRARY_PATH,hostsysroot); \
	$(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_PATH,fp); $(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_CPATH,fp); $(call NLUKI_AUTO_HOST_CLASSIC_SYSROOT_LIBRARY_PATH,fp); \
	$(MKFILE_DIR)/Submodules/glibc/configure \
		--with-build-sysroot=$(NLUKI_HOST_CLASSIC_SYSROOTS)/fp \
...
$(NLUKI_HOST_BUILDROOT)/fp-gcc/Makefile: $(DEPENDS_ON_GCC)
	mkdir -p $(NLUKI_HOST_BUILDROOT)/fp-gcc
	cd $(NLUKI_HOST_BUILDROOT)/fp-gcc; \
	$(MKFILE_DIR)/Submodules/gcc/configure \
		$(NLUKI_GCC_OPTIONS) \
		--prefix=$(NLUKI_HOST_CLASSIC_SYSROOTS)/fp/usr \
...
# --- Make Host Binutils
$(NLUKI_HOSTROOT)/host-firstpass-binutils-install.sentinel: $(NLUKI_HOSTROOT)/host-firstpass-binutils-build.sentinel
	mkdir -p $(NLUKI_HOST_CLASSIC_SYSROOTS)/fp
	cd $(NLUKI_HOST_BUILDROOT)/firstpass-binutils; $(MAKE) install
	touch $(NLUKI_HOSTROOT)/host-firstpass-binutils-install.sentinel

$(NLUKI_HOSTROOT)/host-firstpass-binutils-build.sentinel: $(NLUKI_HOST_BUILDROOT)/firstpass-binutils/Makefile
	cd $(NLUKI_HOST_BUILDROOT)/firstpass-binutils; $(MAKE)
	touch $(NLUKI_HOSTROOT)/host-firstpass-binutils-build.sentinel
...
# --- Configure Host Binutils
$(NLUKI_HOST_BUILDROOT)/firstpass-binutils/Makefile: $(DEPENDS_ON_BINUTILS)
	mkdir -p $(NLUKI_HOST_BUILDROOT)/firstpass-binutils
	cd $(NLUKI_HOST_BUILDROOT)/firstpass-binutils; \
	$(MKFILE_DIR)/Submodules/binutils/configure \
		$(NLUKI_BINUTILS_OPTIONS) \
		--prefix=$(NLUKI_HOST_CLASSIC_SYSROOTS)/fp/usr \
		--disable-nls --enable-gprofng=no --enable-new-dtags \
