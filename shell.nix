...
pkgs.mkShell {
	...
	CPATH = '''';
	C_INCLUDE_PATH = ''${pkgs.gcc-unwrapped.out.outPath}/lib/gcc/x86_64-unknown-linux-gnu/15.2.0/include:${pkgs.gcc-unwrapped.out.outPath}/include:${pkgs.gcc-unwrapped.out.outPath}/lib/gcc/x86_64-unknown-linux-gnu/15.2.0/include-fixed:${pkgs.ncurses.dev.outPath}/include:${pkgs.glibc.dev.outPath}/include:${pkgs.gmp.dev.outPath}/include:${pkgs.mpfr.dev.outPath}/include:${pkgs.elfutils.dev.outPath}/include:${pkgs.openssl_4_0.dev.outPath}/include:${pkgs.zlib.dev.outPath}/include'';
	...
	LIBRARY_PATH = ''${pkgs.gcc-unwrapped.lib.outPath}/lib/:${pkgs.gcc-unwrapped.out.outPath}/lib/:${pkgs.glibc.out.outPath}/lib:${pkgs.binutils-unwrapped.lib.outPath}/lib/:${pkgs.gmp.out.outPath}/lib:${pkgs.mpfr.out.outPath}/lib:${pkgs.elfutils.out.outPath}/lib:${pkgs.openssl_4_0.bin.outPath}/lib:${pkgs.zlib.out.outPath}/lib'';
